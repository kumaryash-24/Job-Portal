...
<div class="wrapper">
  ...
  <div class="content-wrapper" style="margin-left: 0px;">
    ...
    <li><a href="" class="citySearch" data-target="Jaipur"><i class="fa fa-circle-o text-yellow"></i> Jaipur</a></li>
    <li><a href="" class="citySearch" data-target="Surat"><i class="fa fa-circle-o text-yellow"></i> Surat</a></li>
    <li><a href="" class="citySearch" data-target="Lucknow"><i class="fa fa-circle-o text-yellow"></i> Lucknow</a></li>
    <li><a href="" class="citySearch" data-target="Kanpur"><i class="fa fa-circle-o text-yellow"></i> Kanpur</a></li>
    ...
    <li><a href="" class="citySearch" data-target="Bhopal"><i class="fa fa-circle-o text-yellow"></i> Bhopal</a></li>
    <li><a href="" class="citySearch" data-target="Visakhapatnam"><i class="fa fa-circle-o text-yellow"></i> Visakhapatnam</a></li>
    <li><a href="" class="citySearch" data-target="Patna"><i class="fa fa-circle-o text-yellow"></i> Patna</a></li>
    <li><a href="" class="citySearch" data-target="Vadodara"><i class="fa fa-circle-o text-yellow"></i> Vadodara</a></li>
    <li><a href="" class="citySearch" data-target="Ghaziabad"><i class="fa fa-circle-o text-yellow"></i> Ghaziabad</a></li>
</ul>
